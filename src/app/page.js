...
<section className="py-10 sm:py-12 bg-gray-50 text-black">
  <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
      Contáctanos
    </h2>
    {/* AJUSTE: Texto base más pequeño y max-w para mejor legibilidad. Se eliminó el <br /> */}
    <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-8 sm:mb-10 max-w-prose mx-auto">
      ¿Tienes dudas o quieres más información sobre nuestras máquinas? Inicia tu solicitud y te atenderemos con gusto.
    </p>
    ...
    <div className="flex justify-center mb-10">
      <Link
        href="/pages/horarios"
        /*
          AJUSTE PRINCIPAL (BOTÓN):
          - Padding responsivo: `py-3 px-6` en móvil, `sm:py-4 sm:px-8` en pantallas más grandes.
          - Texto responsivo: `text-base` en móvil, `sm:text-lg` en más grandes.
        */
        className="bg-red-600 text-white py-3 px-6 sm:py-4 sm:px-8 rounded-xl font-bold text-base sm:text-lg hover:bg-red-700 hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-3"
      >
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
        </svg>
        
        {/* AJUSTE CLAVE: Se muestra un texto diferente según el tamaño de la pantalla */}
        <span className="sm:hidden">Cotizar</span> {/* Visible solo en pantallas pequeñas */}
        <span className="hidden sm:inline">Solicita una Cotización Personalizada</span> {/* Oculto en pequeñas, visible en sm y más grandes */}
      </Link>
    </div>
    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="flex justify-center gap-4 sm:gap-6 mb-6 sm:mb-8 px-4">
        {/* Los botones de redes sociales ya eran bastante responsivos, se mantienen igual */}
