      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <Link href="/pages/faq" className="hover:text-orange-500 transition-colors">
                  FAQ
                </Link>
              </div>
              <div>
                <Link href="/pages/tienda-billar" className="hover:text-red-500 transition-colors">
                  Tienda de Equipamiento
                </Link>
              </div>
              <div>
                <Link href="/pages/devoluciones" className="hover:text-orange-500 transition-colors">
                  Envío y devoluciones
                </Link>
              </div>
              <div>
                <Link href="/pages/politicas" className="hover:text-orange-500 transition-colors">
                  Política de la tienda
                </Link>
              </div>
              <div>
                <Link href="/pages/privacidad" className="hover:text-orange-500 transition-colors">
                  Políticas de privacidad
                </Link>
              </div>
              <div>
                <Link href="/pages/cookies" className="hover:text-orange-500 transition-colors">
                  Políticas de cookies
                </Link>
              </div>
              <div>
                <Link href="/pages/condiciones" className="hover:text-orange-500 transition-colors">
                  Términos y condiciones
                </Link>
              </div>
              <div>
                <Link href="/pages/pagos" className="hover:text-orange-500 transition-colors">
                  Métodos de pago
                </Link>
              </div>
            </div>
